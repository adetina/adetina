        ...
        _findParticles: function() {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                ...
                b.options.showElement(m), m.data("stellar-startingLeft") ? (m.css("left", m.data("stellar-startingLeft")), m.css("top", m.data("stellar-startingTop"))) : (m.data("stellar-startingLeft", m.css("left")), m.data("stellar-startingTop", m.css("top"))), f = m.position().left, g = m.position().top, h = "auto" === m.css("margin-left") ? 0 : parseInt(m.css("margin-left"), 10), i = "auto" === m.css("margin-top") ? 0 : parseInt(m.css("margin-top"), 10), k = m.offset().left - h, l = m.offset().top - i, m.parents().each(function() {
                    var b = a(this);
                    return !0 === b.data("stellar-offset-parent") ? (n = p, o = q, j = b, !1) : (p += b.position().left, void(q += b.position().top))
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (b = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (b = b.add(this.$element)), b.each(function() {
                ...
                o.data("stellar-backgroundStartingLeft") ? m(o, o.data("stellar-backgroundStartingLeft"), o.data("stellar-backgroundStartingTop")) : (o.data("stellar-backgroundStartingLeft", p[0]), o.data("stellar-backgroundStartingTop", p[1])), h = "auto" === o.css("margin-left") ? 0 : parseInt(o.css("margin-left"), 10), i = "auto" === o.css("margin-top") ? 0 : parseInt(o.css("margin-top"), 10), j = o.offset().left - h - e, k = o.offset().top - i - f, o.parents().each(function() {
                    var b = a(this);
                    return !0 === b.data("stellar-offset-parent") ? (q = s, r = t, l = b, !1) : (s += b.position().left, void(t += b.position().top))
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    ...
                    if (!o) return !1;
                    $hasPopUp = $this.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), toggleMenuClasses($this, o), toggleAnchorClass($hasPopUp), toggleTouchAction($this), $this.off(".superfish").off(".hoverIntent"), $hasPopUp.children(o.popUpSelector).attr("style", function(i, style) {
                        return style.replace(/display[^;]+;?/g, "")
                    }), o.$path.removeClass(o.hoverClass + " " + c.bcClass).addClass(o.pathClass), $this.find("." + o.hoverClass).removeClass(o.hoverClass), o.onDestroy.call($this), $this.removeData("sf-options")
                })
            },
            init: function(op) {
                return this.each(function() {
...
function(e) {
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var e = t.st.retina,
                            n = e.ratio;
                        (n = isNaN(n) ? n() : n) > 1 && (x("ImageHasSize." + U, function(e, t) {
                            t.img.css({
    ...
    function() {
        ...
        var isiPad = function() {
            ...
            parallax = function() {
                isiPad() && isiPhone() || $(window).stellar()
            },
            offcanvas = function() {
                ...
                $clone.attr({
                    ...
                    class: "",
                    id: ""
                }), $("#fh5co-page").prepend($clone), $(".js-fh5co-nav-toggle").on("click", function() {
                ...
                $(".animate-box").waypoint(function(direction) {
                    "down" !== direction || $(this.element).hasClass("animated") || (i++, $(this.element).addClass("item-animate"), setTimeout(function() {
                        $("body .animate-box.item-animate").each(function(k) {
                            var el = $(this);
                            setTimeout(function() {
                                el.addClass("fadeInUp animated"), el.removeClass("item-animate")
                            }, 50 * k, "easeInOutExpo")
                        })
                    }, 100))
                }, {
            ...
            stickyBanner = function() {
                ...
                $stickyElement.length && new Waypoint.Sticky({
                    element: $stickyElement[0],
                    offset: 0
                })
            },
            countDownDate = new Date("August 14, 2020 10:00:00").getTime(),
        ...
        $(function() {
            mainMenu(), parallax(), offcanvas(), mobileMenuOutsideClick(), contentWayPoint(), stickyBanner()
        })
    }();
var google;
if (google.maps.event.addDomListener(window, "load", init), window.Modernizr = function(a, b, c) {
        ...
        C = F(B, "undefined") || F(B.call, "undefined") ? function(a, b) {
            ...
            return D((a + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + a) + n.join("linear-gradient(left top,#9f9, white);" + a)).slice(0, -a.length)), G(j.backgroundImage, "gradient")
        ...
        return e.input || function() {
            ...
            function(a, b) {
                ...
                a.html5 = r, q(b)
            }(this, b), e._version = "2.6.2", e._prefixes = n, e._domPrefixes = q, e._cssomPrefixes = p, e.mq = z, e.hasEvent = A, e.testProp = function(a) {
                return H([a])
            }, e.testAllProps = J, e.testStyles = y, e.prefixed = function(a, b, c) {
                return b ? J(a, b, c) : J(a, "pfx")
            }, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + v.join(" "), e
...
if (+ function(a) {
        ...
        w.prototype = {
            ...
            open: function(n) {
                ...
                t.types = [], a = "", t.ev = n.mainEl && n.mainEl.length ? n.mainEl.eq(0) : o, n.key ? (t.popupsCache[n.key] || (t.popupsCache[n.key] = {}), t.currTemplate = t.popupsCache[n.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, n),
                    t.fixedContentPos = "auto" === t.st.fixedContentPos ? !t.probablyMobile : t.st.fixedContentPos, t.st.modal && (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1, t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = k("bg").on("click" + h, function() {
                        t.close()
                    }), t.wrap = k("wrap").attr("tabindex", -1).on("click" + h, function(e) {
                        t._checkIfClose(e.target) && t.close()
                    }), t.container = k("container", t.wrap)), t.contentContainer = k("content"), t.st.preloader && (t.preloader = k("preloader", t.container, t.st.tLoading));
        ...
        function r(t) {
            var e = ut[t] = {};
            return J.each(t.match(ct) || [], function(t, n) {
                e[n] = !0
            }), e
        }
        ...
        function l(t, e, n) {
            ...
            if (void 0 === n && 1 === t.nodeType)
                if (i = "data-" + e.replace(mt, "-$1").toLowerCase(), "string" == typeof(n = t.getAttribute(i))) {
                    try {
                        n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : gt.test(n) ? J.parseJSON(n) : n)
                    } catch (t) {}
                    ht.set(t, e, n)
                } else n = void 0;
            return n
        ...
        function g(t, e) {
            for (var n = 0, i = t.length; i > n; n++) dt.set(t[n], "globalEval", !e || dt.get(e[n], "globalEval"))
        }
        ...
        function x(t, e, n) {
            ...
            return n = n || Mt(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || J.contains(t.ownerDocument, t) || (s = J.style(t, e)), Ht.test(s) && _t.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function S(t, e, n, i, o) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += J.css(t, n + yt[r], !0, o)), i ? ("content" === n && (s -= J.css(t, "padding" + yt[r], !0, o)), "margin" !== n && (s -= J.css(t, "border" + yt[r] + "Width", !0, o))) : (s += J.css(t, "padding" + yt[r], !0, o), "padding" !== n && (s += J.css(t, "border" + yt[r] + "Width", !0, o)));
            return s
        }
        ...
        function $(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = dt.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && bt(i) && (r[s] = dt.access(i, "olddisplay", w(i.nodeName)))) : (o = bt(i), "none" === n && o || dt.set(i, "olddisplay", o ? n : J.css(i, "display"))));
        ...
        function P(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = J.css(t, "display"), "inline" === ("none" === c ? dt.get(t, "olddisplay") || w(t.nodeName) : c) && "none" === J.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", u.always(function() {
            ...
            if (J.isEmptyObject(p)) "inline" === ("none" === c ? w(t.nodeName) : c) && (f.display = c);
                ...
                h ? "hidden" in h && (d = h.hidden) : h = dt.access(t, "fxshow", {}), r && (h.hidden = !d), d ? J(t).show() : u.done(function() {
                    J(t).hide()
                }), u.done(function() {
                    var e;
                    dt.remove(t, "fxshow");
        ...
        function D(t, e) {
            var n, i, o, r, s;
            for (n in t)
                if (i = J.camelCase(n), o = e[i], r = t[n], J.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = J.cssHooks[i]) && "expand" in s) {
        ...
        function L(t, e, n) {
            var i, o, r = 0,
                ...
                l = function() {
                    if (o) return !1;
                    for (var e = Ut || O(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
        ...
        function F(t, e, n, i) {
            ...
            if (J.isArray(e)) J.each(e, function(e, o) {
                n || he.test(t) ? i(t, o) : F(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            });
        ...
        J.fn = J.prototype = {
            ...
            isPlainObject: function(t) {
                return !("object" !== J.type(t) || t.nodeType || J.isWindow(t) || t.constructor && !Y.call(t.constructor.prototype, "isPrototypeOf"))
            },
            ...
            proxy: function(t, e) {
                var n, i, o;
                return "string" == typeof e && (n = t[e], e = t, t = n), J.isFunction(t) ? (i = W.call(arguments, 2), o = function() {
        ...
        var et = function(t) {
                ...
                if (!i && P) {
                    if (11 !== a && (o = mt.exec(t)))
                        if (s = o[1]) {
                            ...
                            } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && _(e, r) && r.id === s) return n.push(r), n
                        } else {
                    ...
                    if (n = w.relative[t[a].type]) d = [p(f(d), n)];
                        ...
                        if (n = w.filter[t[a].type].apply(null, t[a].matches), n[H]) {
                            ...
                            return g(a > 1 && f(d), a > 1 && u(t.slice(0, a - 1).concat({
                                value: " " === t[a - 2].type ? "*" : ""
                            })).replace(st, "$1"), n, i > a && m(t.slice(a, i)), o > i && m(t = t.slice(i)), o > i && u(t))
                        }
                        d.push(n)
                    }
                return f(d)
            ...
            b = e.support = {}, T = e.isXML = function(t) {
                ...
                return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, N = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", xt, !1) : n.attachEvent && n.attachEvent("onunload", xt)), P = !T(i), b.attributes = o(function(t) {
                    ...
                    return N.appendChild(t).id = H, !i.getElementsByName || !i.getElementsByName(H).length
                ...
                }, L = [], D = [], (b.qsa = gt.test(i.querySelectorAll)) && (o(function(t) {
                ...
                })), (b.matchesSelector = gt.test(j = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && o(function(t) {
                    b.disconnectedMatch = j.call(t, "div"), j.call(t, "[s!='']:x"), L.push("!=", ot)
                }), D = D.length && new RegExp(D.join("|")), L = L.length && new RegExp(L.join("|")), e = gt.test(N.compareDocumentPosition), _ = e || gt.test(N.contains) ? function(t, e) {
                    ...
                    return n || (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !b.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === M && _(M, t) ? -1 : e === i || e.ownerDocument === M && _(M, e) ? 1 : $ ? Z($, t) - Z($, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return I = !0, 0;
                    var n, o = 0,
                        r = t.parentNode,
                ...
                if ((t.ownerDocument || t) !== A && O(t), n = n.replace(ct, "='$1']"), !(!b.matchesSelector || !P || L && L.test(n) || D && D.test(n))) try {
                    var i = j.call(t, n);
                ...
                var e, n = [],
                    i = 0,
                    o = 0;
                if (I = !b.detectDuplicates, $ = !b.sortStable && t.slice(0), t.sort(B), I) {
            ...
            return c.prototype = w.filters = w.pseudos, w.setFilters = new c, C = e.tokenize = function(t, n) {
                ...
                if (n = n || [], 1 === f.length) {
                    ...
                    for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
                        if ((c = w.find[a]) && (i = c(s.matches[0].replace(bt, wt), vt.test(r[0].type) && l(e.parentNode) || e))) {
                            if (r.splice(o, 1), !(t = i.length && u(r))) return K.apply(n, i), n;
                            break
                        }
                }
                return (p || k(t, f))(i, e, !P, n, vt.test(t) && l(e.parentNode) || e), n
            }, b.sortStable = H.split("").sort(B).join("") === H, b.detectDuplicates = !!I, O(), b.sortDetached = o(function(t) {
        ...
        J.filter = function(t, e, n) {
            ...
            is: function(t) {
                return !!i(this, "string" == typeof t && nt.test(t) ? J(t) : t || [], !1).length
            }
        });
        var rt, st = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
        ...
        J.extend({
            ...
            J.fn[t] = function(n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = J.filter(i, o)), this.length > 1 && (lt[t] || J.unique(o), at.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var ct = /\S+/g,
            ut = {};
        ...
        J.fn.ready = function(t) {
            ...
            return pt || (pt = J.Deferred(), "complete" === G.readyState ? setTimeout(J.ready) : (G.addEventListener("DOMContentLoaded", s, !1), t.addEventListener("load", s, !1))), pt.promise(e)
        }, J.ready.promise();
        ...
        J.acceptData = function(t) {
            ...
            remove: function(t, e) {
                ...
                if (void 0 === e) this.cache[r] = {};
                    ...
                    J.isArray(e) ? i = e.concat(e.map(J.camelCase)) : (o = J.camelCase(e), e in s ? i = [e, o] : (i = o, i = i in s ? [i] : i.match(ct) || [])), n = i.length;
                    for (; n--;) delete s[i[n]]
                }
            },
            hasData: function(t) {
        ...
        J.extend({
            ...
            queue: function(t, e, n) {
                var i;
                return t ? (e = (e || "fx") + "queue", i = dt.get(t, e), n && (!i || J.isArray(n) ? i = dt.access(t, e, J.makeArray(n)) : i.push(n)), i || []) : void 0
            },
        ...
        J.event = {
            ...
            add: function(t, e, n, i, o) {
                ...
                if (m)
                    for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = J.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                            return typeof J !== xt && J.event.triggered !== e.type ? J.event.dispatch.apply(t, arguments) : void 0
                        }), e = (e || "").match(ct) || [""], c = e.length; c--;) a = St.exec(e[c]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (p = J.event.special[d] || {}, d = (o ? p.delegateType : p.bindType) || d, p = J.event.special[d] || {}, u = J.extend({
                        type: d,
                        origType: g,
                        data: i,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, r), (f = l[d]) || (f = l[d] = [], f.delegateCount = 0, p.setup && !1 !== p.setup.call(t, i, h, s) || t.addEventListener && t.addEventListener(d, s, !1)), p.add && (p.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, u) : f.push(u), J.event.global[d] = !0)
            },
            ...
            mouseHooks: {
                ...
                filter: function(t, e) {
                    ...
                    return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || G, i = n.documentElement, o = n.body, t.pageX = e.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), t.pageY = e.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)), t.which || void 0 === r || (t.which = 1 & r ? 1 : 2 & r ? 3 : 4 & r ? 2 : 0), t
                }
            },
            fix: function(t) {
            ...
            return this instanceof J.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? c : u) : this.type = t, e && J.extend(this, e), this.timeStamp = t && t.timeStamp || J.now(), void(this[J.expando] = !0)) : new J.Event(t, e)
        }, J.Event.prototype = {
        ...
        J.extend({
            ...
            css: function(t, e, n, i) {
                var o, r, s, a = J.camelCase(e);
                return e = J.cssProps[a] || (J.cssProps[a] = C(t.style, a)), s = J.cssHooks[e] || J.cssHooks[a], s && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = x(t, e, i)), "normal" === o && e in Wt && (o = Wt[e]), "" === n || n ? (r = parseFloat(o), !0 === n || J.isNumeric(r) ? r || 0 : o) : o
            }
        }), J.each(["height", "width"], function(t, e) {
            J.cssHooks[e] = {
                get: function(t, n, i) {
                    return n ? Rt.test(J.css(t, "display")) && 0 === t.offsetWidth ? J.swap(t, qt, function() {
                        return E(t, e, i)
                    }) : E(t, e, i) : void 0
                },
                set: function(t, n, i) {
                    var o = i && Mt(t);
                    return k(t, n, i ? S(t, e, i, "border-box" === J.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
            ...
            J.cssHooks[t + e] = {
                expand: function(n) {
                    for (var i = 0, o = {}, r = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) o[t + yt[i] + e] = r[i] || r[i - 2] || r[0];
                    return o
                }
            ...
            css: function(t, e) {
                return ft(this, function(t, e, n) {
                    var i, o, r = {},
                        s = 0;
                    if (J.isArray(e)) {
                        for (i = Mt(t), o = e.length; o > s; s++) r[e[s]] = J.css(t, e[s], !1, i);
                        return r
                    }
            ...
            run: function(t) {
                ...
                return this.options.duration ? this.pos = e = J.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : I.propHooks._default.set(this), this
            }
        ...
        J.Animation = J.extend(L, {
                tweener: function(t, e) {
                    ...
                    for (var n, i = 0, o = t.length; o > i; i++) n = t[i], Gt[n] = Gt[n] || [], Gt[n].unshift(e)
                },
        ...
        J.extend({
            ...
            ajax: function(t, e) {
                ...
                if (i = _(ue, p, e, x)) {
                    x.readyState = 1, c && d.trigger("ajaxSend", [x, p]), p.async && p.timeout > 0 && (a = setTimeout(function() {
                        x.abort("timeout")
                    }, p.timeout));
                    try {
                        b = 1, i.send(v, n)
        ...
        J.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !J(this).is(":disabled") && me.test(this.nodeName) && !ge.test(t) && (this.checked || !wt.test(t))
                }).map(function(t, e) {
                    var n = J(this).val();
        ...
        t.attachEvent && t.attachEvent("onunload", function() {
        ...
        }), K.cors = !!we && "withCredentials" in we, K.ajax = we = !!we, J.ajaxTransport(function(t) {
            var e;
            return K.cors || we && !t.crossDomain ? {
                send: function(n, i) {
                    ...
                    e = function(t) {
                        return function() {
                            e && (delete ye[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(be[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                                text: r.responseText
                            } : void 0, r.getAllResponseHeaders()))
                        }
                    }, r.onload = e(), r.onerror = e("error"), e = ye[s] = e("abort");
                    try {
        ...
        J.ajaxSetup({
            ...
            var o, r, s, a = !1 !== e.jsonp && (Te.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Te.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Te, "$1" + o) : !1 !== e.jsonp && (e.url += (ie.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
                return s || J.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function() {
                s = arguments
            }, i.always(function() {
                t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, xe.push(o)), s && J.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        J.offset = {
            ...
            offset: function(t) {
                ...
                var e, n, i = this[0],
                    ...
                    r = i && i.ownerDocument;
                return r ? (e = r.documentElement, J.contains(e, i) ? (typeof i.getBoundingClientRect !== xt && (o = i.getBoundingClientRect()), n = z(r), {
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var t = this.offsetParent || ke; t && !J.nodeName(t, "html") && "static" === J.css(t, "position");) t = t.offsetParent;
                    return t || ke
                })
            }
        }), J.each({
            ...
            J.cssHooks[e] = T(K.pixelPosition, function(t, n) {
                return n ? (n = x(t, e), Ht.test(n) ? J(t).position()[e] + "px" : n) : void 0
            })
        }), J.each({
            Height: "height",
            Width: "width"
        ...
        return J.noConflict = function(e) {
            return t.$ === J && (t.$ = Ee), e && t.jQuery === J && (t.jQuery = Se), J
        }, typeof e === xt && (t.jQuery = t.$ = J), J
    }), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        def: "easeOutQuad",
    ...
    o.prototype = {
        ...
        _findParticles: function() {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                ...
                e.options.showElement(f), f.data("stellar-startingLeft") ? (f.css("left", f.data("stellar-startingLeft")),
                    f.css("top", f.data("stellar-startingTop"))) : (f.data("stellar-startingLeft", f.css("left")), f.data("stellar-startingTop", f.css("top"))), r = f.position().left, s = f.position().top, a = "auto" === f.css("margin-left") ? 0 : parseInt(f.css("margin-left"), 10), l = "auto" === f.css("margin-top") ? 0 : parseInt(f.css("margin-top"), 10), u = f.offset().left - a, p = f.offset().top - l, f.parents().each(function() {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (d = g, h = m, c = e, !1) : (g += e.position().left, void(m += e.position().top))
                }), n = f.data("stellar-horizontal-offset") !== i ? f.data("stellar-horizontal-offset") : c !== i && c.data("stellar-horizontal-offset") !== i ? c.data("stellar-horizontal-offset") : e.horizontalOffset, o = f.data("stellar-vertical-offset") !== i ? f.data("stellar-vertical-offset") : c !== i && c.data("stellar-vertical-offset") !== i ? c.data("stellar-vertical-offset") : e.verticalOffset, e.particles.push({
                    $element: f,
                    $offsetParent: c,
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function() {
                ...
                h.data("stellar-backgroundStartingLeft") ? f(h, h.data("stellar-backgroundStartingLeft"), h.data("stellar-backgroundStartingTop")) : (h.data("stellar-backgroundStartingLeft", g[0]), h.data("stellar-backgroundStartingTop", g[1])), a = "auto" === h.css("margin-left") ? 0 : parseInt(h.css("margin-left"), 10), l = "auto" === h.css("margin-top") ? 0 : parseInt(h.css("margin-top"), 10), c = h.offset().left - a - o, u = h.offset().top - l - r, h.parents().each(function() {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (m = y, v = b, p = e, !1) : (y += e.position().left, void(b += e.position().top))
                }), e = h.data("stellar-horizontal-offset") !== i ? h.data("stellar-horizontal-offset") : p !== i && p.data("stellar-horizontal-offset") !== i ? p.data("stellar-horizontal-offset") : n.horizontalOffset, s = h.data("stellar-vertical-offset") !== i ? h.data("stellar-vertical-offset") : p !== i && p.data("stellar-vertical-offset") !== i ? p.data("stellar-vertical-offset") : n.verticalOffset, n.backgrounds.push({
                    $element: h,
                    $offsetParent: p,
        ...
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; o >= 0; o--) i = this.backgrounds[o], i.$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null), f(i.$element, i.startingValueLeft, i.startingValueTop)
        },
        destroy: function() {
    ...
    t.fn.hoverIntent = function(e, n, i) {
        ...
        var r, s, a, l, c = function(t) {
            ...
            u = function(e, n) {
                ...
                a = r, l = s, n.hoverIntent_t = setTimeout(function() {
                    u(e, n)
                }, o.interval)
            },
            p = function(t, e) {
            ...
            f = function(e) {
                var n = jQuery.extend({}, e),
                    i = this;
                i.hoverIntent_t && (i.hoverIntent_t = clearTimeout(i.hoverIntent_t)), "mouseenter" == e.type ? (a = n.pageX, l = n.pageY, t(i).on("mousemove.hoverIntent", c), 1 != i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function() {
                    u(n, i)
                }, o.interval))) : (t(i).off("mousemove.hoverIntent", c), 1 == i.hoverIntent_s && (i.hoverIntent_t = setTimeout(function() {
                    p(n, i)
                }, o.timeout)))
            };
        return this.on({
...
function(t, e) {
    ...
    var n = function() {
        var n = {
            ...
            a = function(e, i) {
                return e.find("li." + i.pathClass).slice(0, i.pathLevels).addClass(i.hoverClass + " " + n.bcClass).filter(function() {
            ...
            c = function(t) {
                ...
                n = n || e, n = "pan-y" === n ? "auto" : "pan-y", t.css({
                    "ms-touch-action": n,
                    "touch-action": n
                })
            },
            ...
            h = function(e) {
                e.retainPath = t.inArray(this[0], e.$path) > -1, this.superfish("hide"), this.parents("." + e.hoverClass).length || (e.onIdle.call(g(this)), e.$path.length && t.proxy(f, e.$path)())
            },
            g = function(t) {
        ...
        return {
            ...
            show: function() {
                ...
                return t.onBeforeShow.call(n), n.stop(!0, !0).animate(t.animation, t.speed, function() {
                    t.onShow.call(n)
                }), this
            },
            destroy: function() {
                return this.each(function() {
                    var e, i = t(this),
                        o = i.data("sf-options");
                    if (!o) return !1;
                    e = i.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), s(i, o), l(e), c(i), i.off(".superfish").off(".hoverIntent"), e.children(o.popUpSelector).attr("style", function(t, e) {
                        return e.replace(/display[^;]+;?/g, "")
                    }), o.$path.removeClass(o.hoverClass + " " + n.bcClass).addClass(o.pathClass), i.find("." + o.hoverClass).removeClass(o.hoverClass), o.onDestroy.call(i), i.removeData("sf-options")
                })
            },
            init: function(e) {
                return this.each(function() {
    ...
    t.fn.superfish = function(e, i) {
        return n[e] ? n[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e ? t.error("Method " + e + " does not exist on jQuery.fn.superfish") : n.init.apply(this, arguments)
...
function(t) {
    ...
    y.prototype = {
        ...
        open: function(n) {
            ...
            return e.isIE7 && (y += " mfp-ie7"), y && e._addClassToMFP(y), e.updateItemHTML(), C("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || i), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                e.content ? (e._addClassToMFP(g), e._setFocus()) : e.bgOverlay.addClass(g), o.on("focusin" + h, e._onFocusIn)
            }, 16), e.isOpen = !0, e.updateSize(d), C(p), n
        },
        close: function() {
            e.isOpen && (C(c), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(m), setTimeout(function() {
                e._close()
    ...
    t.magnificPopup.registerModule(D, {
        ...
        proto: {
            initAjax: function() {
                e.types.push(D), P = e.st.ajax.cursor, x(l + "." + D, j), x("BeforeChange." + D, j)
            },
            getAjax: function(n) {
                ...
                var o = t.extend({
                    ...
                    success: function(i, o, r) {
                        ...
                        C("ParseAjax", s), e.appendContent(t(s.data), D), n.finished = !0, L(), e._setFocus(), setTimeout(function() {
                            e.wrap.addClass(g)
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, _ && clearInterval(_), t.isCheckingImgSize = !1, C("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    o = function(r) {
                        _ && clearInterval(_), _ = setInterval(function() {
                            return i.naturalWidth > 0 ? void e._onImageHasSize(t) : (n > 200 && clearInterval(_), n++, void(3 === n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                        }, r)
                    };
                o(1)
            },
            getImage: function(n, i) {
                ...
                return e._parseMarkup(i, {
                    title: H(n),
                    img_replaceWith: n.img
                }, n), e.resizeImage(), n.hasSize ? (_ && clearInterval(_), n.loadError ? (i.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), e.updateStatus("ready")), i) : (e.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), e.findImageSize(n)), i)
            }
        }
    });
    var M, R = function() {
                ...
                return t(this).each(function() {
                    ...
                    if (e) {
                        ...
                        s.on("touchstart" + i, function(t) {
                            u = !1, f = 1, p = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], l = p.clientX, c = p.clientY, w.on("touchmove" + i, function(t) {
                                p = t.originalEvent ? t.originalEvent.touches : t.touches, f = p.length, p = p[0], (Math.abs(p.clientX - l) > 10 || Math.abs(p.clientY - c) > 10) && (u = !0, n())
                            }).on("touchend" + i, function(t) {
                                n(), u || f > 1 || (r = !0, t.preventDefault(), clearTimeout(a), a = setTimeout(function() {
                                    r = !1
                                }, 1e3), o())
                            })
                        })
        ...
        var t = function() {
            ...
            o = function() {
                ...
                t.attr({
                    ...
                    class: "",
                    id: ""
                }), $("#fh5co-page").prepend(t), $(".js-fh5co-nav-toggle").on("click", function() {
                    $("body").hasClass("fh5co-offcanvas") ? $("body").removeClass("fh5co-offcanvas") : $("body").addClass("fh5co-offcanvas")
                }), $("#offcanvas-menu").css("height", $(window).height()), $(window).resize(function() {
                    var t = $(window);
